###########################################################################
## Makefile generated for component 'stepMotor'. 
## 
## Makefile     : stepMotor.mk
## Generated on : Sun Jun 30 21:00:04 2024
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/stepMotor.elf
...
COMPILER_COMMAND_FILE     = stepMotor_comp.rsp
CMD_FILE                  = stepMotor.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/stepMotor.elf
...
DEFINES_STANDARD = -DMODEL=stepMotor -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)/stepMotor_ert_rtw/stepMotor.c $(START_DIR)/stepMotor_ert_rtw/stepMotor_data.c
...
OBJS = stepMotor.o stepMotor_data.o
...
%.o : $(START_DIR)/stepMotor_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/stepMotor_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/stepMotor_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/stepMotor_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/stepMotor_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
stepMotor.o : $(START_DIR)/stepMotor_ert_rtw/stepMotor.c
	$(CC) $(CFLAGS) -o "$@" "$<"


stepMotor_data.o : $(START_DIR)/stepMotor_ert_rtw/stepMotor_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"
